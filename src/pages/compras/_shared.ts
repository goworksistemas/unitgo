...
export const ITEM_STATUS_META: Record<CmpItemStatus, StatusMeta> = {
  pendente:   { label: 'Cotação / Pedido', badge: 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300',         dot: 'bg-gray-400' },
  ...
  atendido:   { label: 'Recebido',         badge: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300', dot: 'bg-emerald-500' },
