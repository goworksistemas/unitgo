...
const STATUS_CONFIG: Record<PurchaseRequestStatus, { label: string; variant: 'default' | 'secondary' | 'destructive' | 'outline'; className?: string }> = {
  ...
  pending_director: { label: 'Aguardando Diretoria', variant: 'outline', className: 'bg-slate-50 dark:bg-slate-900/30 text-slate-700 dark:text-slate-300 border-slate-300' },
  ...
  in_purchase: { label: 'Em Compra', variant: 'outline', className: 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-blue-300' },
