              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  {batchRequests.length > 3 && (
                    <p className="text-xs text-muted-foreground">+{batchRequests.length - 3} mais...</p>
                  )}
                </div>

                {controllerConfirmation && (
                  <div className="pt-3 border-t">
                    <p className="text-xs font-medium text-foreground mb-2">Confirmação do Controlador:</p>
